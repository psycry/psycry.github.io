    ...
    <div className="animate-fade-in bg-slate-900 text-white">
        <section className="py-12 bg-slate-800/50">
            <div className="container mx-auto px-6 text-center">
                <h1 className="text-4xl md:text-5xl font-bold text-white">The Launchpad</h1>
        ...
        <section className="py-20">
            <div className="container mx-auto px-6">
                <div className="grid md:grid-cols-2 gap-16 items-center mb-20">
                    <div>
                        <h2 className="text-3xl font-bold text-white mb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-purple-500">Nomad-Ready Applications</h2>
                        ...
                        <ul className="space-y-3 text-slate-300">
                            ...
                            <li className="flex items-center"><span className="text-purple-400 mr-3 text-xl">&rarr;</span>API Integrations to streamline your life</li>
                        </ul>
                    </div>
                    <div>
                ...
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="order-1 md:order-2">
                        <h2 className="text-3xl font-bold text-white mb-4 bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-teal-500">Independence Consulting</h2>
                        <p className="text-slate-300 leading-relaxed mb-6">An idea is not enough. We provide the roadmap to turn your dream of a nomadic life into a reality, covering everything from tech stacks to tax strategies.</p>
                        <ul className="space-y-3 text-slate-300">
