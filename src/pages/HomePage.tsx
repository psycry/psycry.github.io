    ...
    <div className="animate-fade-in">
        ...
        <section className="py-20 bg-slate-800/50">
            <div className="container mx-auto px-6 text-center">
                <h2 className="text-3xl font-bold text-slate-100 mb-12">Your Digital Launchpad</h2>
                <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    ...
                    <div className="bg-slate-900 p-8 rounded-lg border border-slate-700 hover:border-teal-500 transition-all transform hover:-translate-y-2">
                        ...
                        <p className="text-slate-400 mb-6">Step-by-step guidance on the tech, strategy, and mindset needed to launch your product.</p>
